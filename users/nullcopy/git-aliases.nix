...
in
{
  programs.zsh.initExtra = ''
    ## --- oh-my-zsh git helper functions ----------------------------------------
  ...
  ## --- complex aliases (implemented as functions) ------------------------------
  programs.zsh.initExtra = lib.mkAfter ''
    ...
    # Pretty git log with optional argument
    ...
    # List tags matching a prefix, sorted by version
    function gtl() {
